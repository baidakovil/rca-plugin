...
{
    /// <summary>
    /// The main external application class for the Rca.Core.
    /// </summary>
    public class RcaApp : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            try
            {
                ...
                var buttonData = new PushButtonData(
                    ...
                    typeof(Rca.Core.Commands.ShowDockablePanelCommand).FullName);
