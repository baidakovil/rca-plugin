...
internal class MetricsUpdater
{
  ...
  {
    var arguments = $"msbuild \"{projectPath}\" /t:Build /p:GenerateMetricsDashboard=true /p:BuildProjectReferences=false /p:SkipMetricsReporterBuild=true /p:RoslynMetricsEnabled=true /p:SarifMetricsEnabled=true";
